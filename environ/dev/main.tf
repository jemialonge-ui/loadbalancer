...
module "dev_alb_security_group" {
  ...
  project_name        = "${var.environment_name}_project"
  vpc_id              = module.vpc_dev.vpc_id
  #load_balancer_security_group_id = module.dev_security_group.security_group_id
...
module "ec2_dev1" {
  ...
  #key_name            = module.key_pair_dev.key_pair_filename
  vpc_id              = module.vpc_dev.vpc_id
...
module "alb_dev" {
  source                      = "../../loadbalancer"
  region_name                 = var.region_name
  security_groups_for_lb_id   = module.dev_alb_security_group.security_group_id
  ec2_dns                     = [module.ec2_dev1.webserver_public_dns, module.ec2_dev2.webserver_public_dns]
  ec2_ids                     = [module.ec2_dev1.ec2_instance_id, module.ec2_dev2.ec2_instance_id]
  subnet_ids                  = module.vpc_dev.Public_subnet_ids 
  vpc_id                      = module.vpc_dev.vpc_id

  #depends_on                  = [module.dev_alb_security_group, module.vpc_dev]
}
